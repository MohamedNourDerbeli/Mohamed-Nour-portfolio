    ...
    <section id="blog" ref={sectionRef} className="section-padding">
      <div className="w-full max-w-7xl mx-auto px-5 md:px-10">
        ...
        <div className="mt-16">
          {/* Featured Article */}
          <div className="mb-12">
            <article className={`blog-card group relative overflow-hidden rounded-2xl backdrop-blur-sm transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl ${
              isDark 
              ...
              <div className="md:flex">
                ...
                <div className="md:w-1/2 p-8">
                  ...
                  <h3 className={`text-2xl md:text-3xl font-bold mb-4 group-hover:text-blue-400 transition-colors duration-300 ${
            ...
            {articles.slice(1).map((article) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h4 className={`text-lg font-bold mb-3 group-hover:text-blue-400 transition-colors line-clamp-2 leading-tight ${
                    isDark ? "text-white" : "text-gray-900"
                  }`}>
                    {article.title}
                  </h4>
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    ...
                    {article.tags.length > 3 && (
                      <span className={`px-2 py-1 rounded text-xs ${
                        isDark ? "bg-gray-700/50 text-gray-400" : "bg-gray-200/80 text-gray-600"
                      }`}>
                        +{article.tags.length - 3}
                      </span>
                    )}
            ...
            <div className={`p-8 rounded-2xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 backdrop-blur-sm ${
              ...
              <div className="flex items-center justify-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className={isDark ? "text-gray-400" : "text-gray-600"}>@nourmohamedderbeli</p>
                </div>
              </div>
