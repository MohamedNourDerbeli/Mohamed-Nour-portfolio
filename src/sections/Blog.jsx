    ...
    <section id="blog" ref={sectionRef} className="section-padding">
      <div className="w-full max-w-7xl mx-auto px-5 md:px-10">
        ...
        <div className="mt-16">
          {/* Featured Article */}
          <div className="mb-12">
            <article className="blog-card group relative overflow-hidden rounded-2xl bg-gray-900/40 dark:bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 hover:border-gray-600/50 transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.slice(1).map((article) => (
              <article
                key={article.id}
                className="blog-card group relative overflow-hidden rounded-xl bg-gray-900/40 dark:bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 hover:border-gray-600/50 transition-all duration-500 hover:scale-[1.02] hover:shadow-xl"
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gray-900/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white font-medium hover:bg-white/20 transition-all duration-300 flex items-center gap-2"
                    >
                      Read on Medium
                      <svg
                        className="w-4 h-4"
                ...
                <div className="p-6">
                  ...
                  <h4 className="text-lg font-bold text-white mb-3 group-hover:text-blue-400 transition-colors line-clamp-2 leading-tight">
                    {article.title}
                  </h4>
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {article.tags.slice(0, 3).map((tag, index) => (
                      <span
                        key={index}
                        className="px-2 py-1 bg-gray-700/50 text-gray-400 rounded text-xs hover:bg-gray-600/50 transition-colors"
                      >
                        {tag}
                      </span>
                    ))}
          ...
          <div className="mt-16 text-center">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 backdrop-blur-sm">
              <div className="flex items-center justify-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">@nourmohamedderbeli</p>
                </div>
              </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={index}
                  className="px-4 py-2 bg-gray-700/50 text-gray-300 border border-gray-600/50 rounded-full text-sm font-medium hover:bg-gray-600/50 hover:text-white transition-all duration-300"
                >
